...
const PasswordRecover = ({ navigation, route }) => {
  ...
  return (
    <View style={_styles.KzIbqBWM}>
      ...
      >
        {renderImage()}
        <Text style={styles.heading}>{t("ResetPassword.HeadingText")}</Text>
        <View style={styles.fieldContainer}>
          <Text style={styles.label}>
            {t("ResetPassword.LabelEmailAddress")}
          </Text>
          <TextInput
            value={email}
            onChangeText={value => setEmail(value)}
            placeholder={t("ResetPassword.PlaceholderEmailAddress")}
            size="small"
        ...
        >
          <Text style={[styles.resetText, buttonTextStyle]}>
            {t("ResetPassword.ResetButtonText")}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          activeOpacity={0.7}
        ...
        >
          <Text style={[styles.textRow]}>
            {t("ResetPassword.BackToLoginButtonText")}
          </Text>
        </TouchableOpacity>
      </KeyboardAwareScrollView>
    </View>
